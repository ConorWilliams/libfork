#
# @copyright (c) 2009-2014 The University of Tennessee and The University of Tennessee Research
# Foundation. All rights reserved. @copyright (c) 2012-2014 Inria. All rights reserved. @copyright
# (c) 2012-2014 Bordeaux INP, CNRS (LaBRI UMR 5800), Inria, Univ. Bordeaux. All rights reserved.
#
# * Find HWLOC include dirs and libraries Use this module by invoking find_package with the form:
#   find_package(HWLOC [REQUIRED]) # Fail with error if hwloc is not found
#
# This module finds headers and hwloc library. Results are reported in variables: HWLOC_FOUND - True
# if headers and requested libraries were found HWLOC_INCLUDE_DIRS    - hwloc include directories
# HWLOC_LIBRARY_DIRS    - Link directories for hwloc libraries HWLOC_LIBRARIES       - hwloc
# component libraries to be linked
#
# The user can give specific paths where to find the libraries adding cmake options at configure
# (ex: cmake path/to/project -DHWLOC_DIR=path/to/hwloc): HWLOC_DIR             - Where to find the
# base directory of hwloc HWLOC_INCDIR          - Where to find the header files HWLOC_LIBDIR -
# Where to find the library files The module can also look for the following environment variables
# if paths are not given as cmake variable: HWLOC_DIR, HWLOC_INCDIR, HWLOC_LIBDIR

# =============================================================================
# Copyright 2012-2013 Inria Copyright 2012-2013 Emmanuel Agullo Copyright 2012-2013 Mathieu Faverge
# Copyright 2012      Cedric Castagnede Copyright 2013      Florent Pruvost
#
# Distributed under the OSI-approved BSD License (the "License"); see accompanying file
# MORSE-Copyright.txt for details.
#
# This software is distributed WITHOUT ANY WARRANTY; without even the implied warranty of
# MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the License for more information.
# =============================================================================
# (To distribute this file outside of Morse, substitute the full License text for the above
# reference.)
...
if(NOT HWLOC_FOUND)
  set(HWLOC_DIR
      ""
      CACHE PATH "Installation directory of HWLOC library"
  )
...
if(HWLOC_DIR
   ...
   OR ENV_HWLOC_DIR
   OR (ENV_HWLOC_INCDIR AND ENV_HWLOC_LIBDIR)
)
...
if((NOT PKG_CONFIG_EXECUTABLE)
   OR (PKG_CONFIG_EXECUTABLE AND NOT HWLOC_FOUND)
   OR (HWLOC_GIVEN_BY_USER)
)
...
if(HWLOC_LIBRARIES)
  ...
  if(${first_lib_path} MATCHES "/lib(32|64)?$")
    ...
    set(HWLOC_DIR_FOUND
        "${not_cached_dir}"
        CACHE PATH "Installation directory of HWLOC library" FORCE
    )
  else()
    set(HWLOC_DIR_FOUND
        "${first_lib_path}"
