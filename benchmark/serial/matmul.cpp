 ...
 *
 * Note according to its own check it is not cserialuting this correctly!
...
int main(int argc, char *argv[]) {
  ...
  run("serial-matmul-n=128", 128);
  run("serial-matmul-n=256", 256);
  run("serial-matmul-n=512", 512);
  run("serial-matmul-n=1024", 1024);
  return 0;
}