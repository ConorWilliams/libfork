...
inline void setup_tree(int i) {
  switch (i) {
    case uts_t1:    setup_t1();    break;
    case uts_t1l:   setup_t1l();   break;
    case uts_t1xxl: setup_t1xxl(); break;
    case uts_t3:    setup_t3();    break;
    case uts_t3l:   setup_t3l();   break;
    case uts_t3xxl: setup_t3xxl(); break;
...
inline auto expected_result(int i) -> result {
  switch (i) {
    case uts_t1:    return {10,    4130071,    3305118};
    case uts_t1l:   return {13,    102181082,  81746377};
    case uts_t1xxl: return {15,    4230646601, 3384495738};
    case uts_t3:    return {1572,  4112897,    3599034};
    case uts_t3l:   return {17844, 111345631,  89076904};
    case uts_t3xxl: return {99049, 2793220501, 1396611250};
    default:        std::unreachable();
  }
}
