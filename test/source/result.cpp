...
inline constexpr bool test_value =
    requires(result<int> r1, result<int> const r2, int a, int const& b) {
...
inline constexpr bool test_ref =
    requires(result<int&> r1, result<int&> const r2, int a, int const b) {
      { r1.return_value(a) };
...
inline constexpr bool test_const_ref =
    requires(result<int const&> r1, result<int const&> const r2, int a, int const b) {
      { r1.return_value(a) };
      { r1.return_value(b) };
...
inline constexpr bool test_r_ref =
    requires(result<int&&> r1, result<int&&> const r2, int a, int const b) {
...
inline constexpr bool test_const_r_ref =
    requires(result<int const&&> r1, result<int const&&> const r2, int a, int const b) {
      { r1.return_value(std::move(a)) };
